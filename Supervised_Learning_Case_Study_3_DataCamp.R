...
#Comment - The people who say 'Elections don't matter are less likely to vote and same
# in case of who say 'Crime is very Important'
...
#We can clearly see that here randomforest model overfits the data as;
#The sensitivity is zero and no similar to specifity.
